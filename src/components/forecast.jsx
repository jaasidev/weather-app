...
export function Forecast ({ contenido }) {
  ...
  return (
    <section className=' lg:pl-4 flex flex-col items-center justify-center gap-2 w-full sm:row-start-1 sm:row-end-5 sm:h-full sm:col-start-5 sm:col-end-7  lg:col-end-12 lg:pt-5'>
