function Day () {
  return (
    <svg version='1.1' className='sm:w-full max-h-72 lg:max-h-[400px] text-yellow-400' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 96 96' enable-background='new 0 0 96 96'>
