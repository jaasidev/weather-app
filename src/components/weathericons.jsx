function Day ({ day }) {
  return day === 'day'
    ? <svg
        version='1.1' className='lg:w-full max-h-72 lg:max-h-[600px] text-yellow-400' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 96 96' enable-background='new 0 0 96 96'
      >
