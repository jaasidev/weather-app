function Day ({ day }) {
  return day === 'day'
    ? <svg
        version='1.1' className='text-yellow-400' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 96 96' enable-background='new 0 0 96 96'
      >
...
export function Clima ({ codigo, dia, props }) {
  return (
    <div className={`w-full max-h-40 flex items-center justify-center my-3 ${props}`}>
